    ...
    <div class="col-md-8">
      ...
      <div class="mb-5">
        ...
        <div class="progress" style="height: 30px">
          <div id="main-progress-bar" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
            style="width: <?php echo $progress_width; ?>%"
            aria-valuenow="<?php echo str_replace('%', '', $progress_width); ?>" aria-valuemin="0" aria-valuemax="100">
