...
<section class="order-section" style="padding-top: 110px; flex: 1; padding-left: 10%; padding-right: 10%; padding-bottom: 40px; display: flex; flex-direction: column; align-items: center;">
          ...
          <form action="keranjang.php" method="POST" id="orderForm">
            <div class="field">
              ...
              <select id="serviceSelect" onchange="updatePlaceholder()">
                ...
                <option value="Cuci Kering" data-price="6000" data-unit="kg" data-estimate="2 Hari">Cuci Kering (Rp 6.000/kg)</option>
                <option value="Cuci Setrika" data-price="7000" data-unit="kg" data-estimate="2 Hari">Cuci Setrika (Rp 7.000/kg)</option>
                <option value="Setrika Saja" data-price="5000" data-unit="kg" data-estimate="1 Hari">Setrika Saja (Rp 5.000/kg)</option>
                <option value="Cuci Karpet" data-price="15000" data-unit="pcs" data-estimate="3 Hari">Cuci Karpet (Rp 15.000/pcs)</option>
                <option value="Cuci Selimut" data-price="12000" data-unit="pcs" data-estimate="2 Hari">Cuci Selimut (Rp 12.000/pcs)</option>
                <option value="Cuci Jas" data-price="25000" data-unit="pcs" data-estimate="3 Hari">Cuci Jas (Rp 25.000/pcs)</option>
              </select>
            </div>
              ...
              <div class="customer-grid">
                ...
                <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                  <div style="flex: 1; min-width: 200px">
                    <label class="fw-bold" style="font-size: 0.9rem; display: block; margin-bottom: 10px;">Metode Pengambilan:</label>
                    <div style="display: flex; gap: 15px; flex-wrap: wrap">
                      <label style="font-size: 0.85rem; cursor: pointer; display: flex; align-items: center; gap: 5px;">
                        <input type="radio" name="deliveryMethod" value="Ambil Sendiri" checked onchange="calculateTotal()"> Ambil Sendiri
                      </label>
                      <label style="font-size: 0.85rem; cursor: pointer; display: flex; align-items: center; gap: 5px;">
                        <input type="radio" name="deliveryMethod" value="Kurir Jemput" onchange="calculateTotal()"> Kurir Jemput
                      </label>
                    </div>
                  </div>
                ...
                <div class="field full-width">
                  ...
                  <input type="text" name="custAddress" id="custAddress" required placeholder="Masukkan alamat lengkap penjemputan..." 
                    class="capitalize-input" value="<?php echo htmlspecialchars($user_data['customer_address'] ?? ''); ?>" />
                </div>
              </div>
            </div>
        ...
        <div class="summary-card">
          ...
          <div class="total-block" id="totalBlock" style="width: 100%; text-align: left; display: block; margin-top: 20px;">
            <div style="width: 100%; display: flex; flex-direction: column; gap: 8px; margin-bottom: 15px;">
              ...
              <div style="display: flex; justify-content: space-between; width: 100%; font-size: 0.85rem; color: #777; border-bottom: 1px dashed #ddd; padding-bottom: 10px;">
